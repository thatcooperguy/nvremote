package com.gridstreamer.app.ui.theme
...
private val GridStreamerColorScheme = darkColorScheme(
    primary = CsGreen,
    onPrimary = CsBlack,
...
@Composable
fun GridStreamerTheme(
    content: @Composable () -> Unit
) {
    val colorScheme = GridStreamerColorScheme
    ...
    MaterialTheme(
        ...
        typography = GridStreamerTypography,
        content = content
    )
}
