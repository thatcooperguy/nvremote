///////////////////////////////////////////////////////////////////////////////
// main.cpp -- Entry point for crazystream-host.exe
//
...
int main(int argc, char* argv[]) {
    ...
    CS_LOG(INFO, "crazystream-host starting...");
    ...
    if (!ipc_pipe_name.empty()) {
        ...
        CS_LOG(INFO, "crazystream-host exiting (IPC mode)");
#ifdef _WIN32
        CoUninitialize();
#endif
        return 0;
    ...
    std::fprintf(stderr,
        "\ncrazystream-host is running in standalone mode.\n"
    ...
    CS_LOG(INFO, "crazystream-host exiting");
