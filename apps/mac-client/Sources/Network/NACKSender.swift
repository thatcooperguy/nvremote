...
//
// Mirrors the C++ NackSender from crazystream-viewer. Tracks incoming packet
...
final class NACKSender: @unchecked Sendable {
    ...
    private let timerQueue = DispatchQueue(label: "com.crazystream.nack-sender", qos: .userInteractive)
