...
Displayed during an active streaming session. Shows the remote nvstreamer content
...
|                                                                      |
|                                                                      |
|                   [nvstreamer Video Stream]                           |
|                   (Full screen, no borders,                          |
|                    rendered by nvstreamer client                     |
...
- NVIDIA Brand Guidelines (internal)
