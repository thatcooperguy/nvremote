...
// HostInfo holds information about the nvremote installation and process state.
...
func Detect(configuredPath string) (*HostInfo, error) {
	info := &HostInfo{}
...
// findHostPath searches common installation directories for nvremote.exe.
func findHostPath() string {
	candidates := []string{
