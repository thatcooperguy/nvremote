///////////////////////////////////////////////////////////////////////////////
// addon.cpp -- Node.js N-API module entry point for gridstreamer-viewer
//
...
Napi::Object Init(Napi::Env env, Napi::Object exports) {
    CS_LOG(INFO, "gridstreamer-viewer N-API addon loading");
    ...
    CS_LOG(INFO, "gridstreamer-viewer N-API addon loaded successfully");
    return exports;
}

}  // anonymous namespace

NODE_API_MODULE(gridstreamer_viewer, Init)
