...
An open-source GPU remote streaming platform for secure, low-latency access to your machines from anywhere.
...
### Colors
- **Primary:** NVIDIA Green `#76B900` (nv-green)
- **Background:** Deep Black `#050505` (nv-dark)
- **Surface:** `#0A0A0A` (nv-surface)
- **Card:** `#0F0F0F` (nv-card)
