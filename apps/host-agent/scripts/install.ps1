...
<#
.SYNOPSIS
    Installs the NVIDIA Remote Stream Host Agent as a Windows service.
...
.PARAMETER BinaryPath
    Path to the built nvrs-agent.exe binary. Defaults to the binary in the current directory.

.PARAMETER ControlPlaneURL
    URL of the NVRemoteStream control plane. If not provided, the script will prompt.
...
if ([string]::IsNullOrEmpty($ControlPlaneURL)) {
    ...
    $ControlPlaneURL = Read-Host "Enter the Control Plane URL (e.g., https://nvrs.example.com)"
}
...
$configContent = @"
# NVIDIA Remote Stream Host Agent Configuration
# Generated by install.ps1 on $(Get-Date -Format "yyyy-MM-dd HH:mm:ss")

control_plane_url: "$ControlPlaneURL"
bootstrap_token: "$BootstrapToken"
host_name: "$hostname"
nvstreamer_path: "C:\\Program Files\\NVIDIA\\nvstreamer\\nvstreamer.exe"
nvstreamer_ports:
  video: 8443
  audio: 8444
  input: 8445
