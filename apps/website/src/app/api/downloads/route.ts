      ...
      host: [
        {
          platform: 'windows',
          arch: 'x64',
          filename: 'GridStreamerHost-v0.2.1-alpha-win64.zip',
          sizeLabel: '~48 MB',
        ...
        },
        {
          platform: 'linux',
          arch: 'x64',
          filename: 'GridStreamerHost-v0.2.1-alpha-amd64.deb',
          sizeLabel: '~42 MB',
        ...
        },
        {
          platform: 'macos',
          arch: 'universal',
          filename: 'GridStreamerHost-v0.2.1-alpha-universal.pkg',
          sizeLabel: '~45 MB',
      ...
      client: [
        {
          platform: 'windows',
          arch: 'x64',
          filename: 'GridStreamer-0.1.0-Setup.exe',
          sizeLabel: '~35 MB',
        ...
        },
        {
          platform: 'macos',
          arch: 'universal',
          filename: 'GridStreamerClient-v0.2.1-alpha-universal.dmg',
          sizeLabel: '~38 MB',
        ...
        },
        {
          platform: 'linux',
          arch: 'x64',
          filename: 'GridStreamerClient-v0.2.1-alpha-x86_64.AppImage',
          sizeLabel: '~40 MB',
        ...
        },
        {
          platform: 'android',
          arch: 'arm64',
          filename: 'GridStreamer-v0.2.1-alpha.apk',
          sizeLabel: '~25 MB',
          url: '/api/download/android-client',
          playStoreUrl:
            'https://play.google.com/store/apps/details?id=dev.gridstreamer.client',
        },
        {
          platform: 'web',
          arch: 'any',
