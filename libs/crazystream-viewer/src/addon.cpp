///////////////////////////////////////////////////////////////////////////////
// addon.cpp -- Node.js N-API module entry point for crazystream-viewer
//
...
Napi::Object Init(Napi::Env env, Napi::Object exports) {
    CS_LOG(INFO, "crazystream-viewer N-API addon loading");
    ...
    CS_LOG(INFO, "crazystream-viewer N-API addon loaded successfully");
    return exports;
}

}  // anonymous namespace

NODE_API_MODULE(crazystream_viewer, Init)
